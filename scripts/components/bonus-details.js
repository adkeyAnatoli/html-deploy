...
import { siteName } from "../config/config.js";
...
export function renderBonusDetails() {
  ...
  head.innerHTML = [
    "<p>Casinò</p>",
    '<p class="hide-1000">Bonus</p>',
    "<p>Valutare</p>",
    "<p>Free Spins</p>",
    "<p>Info</p>",
    '<p class="hide-850">Ottenere</p>',
  ].join("");
  ...
  const renderRow = (offer) => {
    ...
    cellBonus.innerHTML = "<p>Bonus di benvenuto</p>";
    ...
    get.textContent = "Ottieni Il Bonus";
  ...
  function createAccordion(offer) {
    ...
    r1.appendChild(createEl("p", { text: "Importo massimo:" }));
    r1.appendChild(
      createEl("p", {
    ...
    r3.appendChild(createEl("p", { text: "Codice bonus:" }));
    r3.appendChild(
      createEl("p", {
        className: "tableBody_last",
    ...
    lastBtn.textContent = "Ottieni Il Bonus";
